              ...
              <motion.div initial={{ opacity: 0, x: 60 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: '-60px' }} transition={{ type: 'spring', stiffness: 60, damping: 16 }} className="space-y-6">
                <div>
                  ...
                  <div className="rounded-xl overflow-hidden shadow-card h-[280px]">
                    <iframe src="https://maps.google.com/maps?q=Brutech+Engineers+Kukatpally+Hyderabad&t=&z=16&ie=UTF8&iwloc=B&output=embed" width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Head Office - Hyderabad"></iframe>
                  </div>
                </div>
                <div>
